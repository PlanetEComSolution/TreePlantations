...
import com.planet.treeplantations.Activities.LoginActivity
import com.planet.treeplantations.Activities.MainActivity
...
class Splash_Activity : AppCompatActivity() {
    ...
    internal val mRunnable: Runnable = Runnable {
        ...
        if (!(pref_user?.loadPreferences("Id").equals(null) || pref_user?.loadPreferences("Id").equals(""))) {
