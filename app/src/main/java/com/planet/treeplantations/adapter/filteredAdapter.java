...
public class filteredAdapter extends ArrayAdapter<Project_Code_Responce_Model> {

    private List<Project_Code_Responce_Model> objects;
    private Context context;
    private Filter filter;

    public filteredAdapter(Context context, int resourceId,	List<Project_Code_Responce_Model> objects) {
