...
public class DashBoard_Details_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Details");
        context = DashBoard_Details_Activity.this;
        ...
        image_adapter = new Image_Adapter(DashBoard_Details_Activity.this, arrayList);
        GridLayoutManager layoutManager = new GridLayoutManager(DashBoard_Details_Activity.this, 2);
        ...
        binding.btnLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!kml_file.trim().equalsIgnoreCase("")) {
                    Intent intent = new Intent(DashBoard_Details_Activity.this, KmlDemoActivity.class);
    ...
    private void user_info_API() {
        ...
        // Call<Details_Responce_Model> call = apiService.details("Bihar","1","Admin","Admin",id);
        ...
        call.enqueue(new Callback<Details_Responce_Model>() {

            @Override
            public void onResponse(Call<Details_Responce_Model> call, Response<Details_Responce_Model> response) {
                dialog.dismiss();
                details_responce_models = response.body();
            ...
            @Override
            public void onFailure(Call<Details_Responce_Model> call, Throwable t) {
                dialog.dismiss();
                Toast.makeText(DashBoard_Details_Activity.this, "Network Error", Toast.LENGTH_SHORT).show();
            }
        });
    }
